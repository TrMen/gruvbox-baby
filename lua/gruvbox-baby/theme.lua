...
function M.setup(config)
  ...
  theme.base = {
    ...
    ["WinBar"] = { bg = c.medium_gray },

    ["NavicText"] = { fg = c.soft_yellow, bg = c.medium_gray },
    ["NavicIconsFile"] = { fg = c.light_blue, bg = c.medium_gray },
    ["NavicIconsModule"] = { fg = c.light_blue, bg = c.medium_gray },
    ["NavicIconsNamespace"] = { fg = c.forest_green, bg = c.medium_gray },
    ["NavicIconsPackage"] = { fg = c.light_blue, bg = c.medium_gray },
    ["NavicIconsClass"] = { fg = c.light_blue, bg = c.medium_gray },
    ["NavicIconsMethod"] = { fg = c.light_blue, bg = c.medium_gray },
    ["NavicIconsProperty"] = { fg = c.light_blue, bg = c.medium_gray },
    ["NavicIconsField"] = { fg = c.light_blue, bg = c.medium_gray },
    ["NavicIconsConstructor"] = { fg = c.light_blue, bg = c.medium_gray },
    ["NavicIconsEnum"] = { fg = c.light_blue, bg = c.medium_gray },
    ["NavicIconsInterface"] = { fg = c.light_blue, bg = c.medium_gray },
    ["NavicIconsFunction"] = { fg = c.light_blue, bg = c.medium_gray },
    ["NavicIconsVariable"] = { fg = c.light_blue, bg = c.medium_gray },
    ["NavicIconsConstant"] = { fg = c.light_blue, bg = c.medium_gray },
    ["NavicIconsString"] = { fg = c.light_blue, bg = c.medium_gray },
    ["NavicIconsNumber"] = { fg = c.light_blue, bg = c.medium_gray },
    ["NavicIconsBoolean"] = { fg = c.light_blue, bg = c.medium_gray },
    ["NavicIconsArray"] = { fg = c.light_blue, bg = c.medium_gray },
    ["NavicIconsObject"] = { fg = c.light_blue, bg = c.medium_gray },
    ["NavicIconsKey"] = { fg = c.light_blue, bg = c.medium_gray },
    ["NavicIconsNull"] = { fg = c.light_blue, bg = c.medium_gray },
    ["NavicIconsEnumMember"] = { fg = c.light_blue, bg = c.medium_gray },
    ["NavicIconsStruct"] = { fg = c.light_blue, bg = c.medium_gray },
    ["NavicIconsEvent"] = { fg = c.light_blue, bg = c.medium_gray },
    ["NavicIconsOperator"] = { fg = c.light_blue, bg = c.medium_gray },
    ["NavicIconsTypeParameter"] = { fg = c.light_blue, bg = c.medium_gray },
    ["NavicSeparator"] = { fg = c.light_blue, bg = c.medium_gray },
